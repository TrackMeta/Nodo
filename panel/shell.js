...
const NAV = [
  ...
  { id:"disparadores",label:"Disparadores IA",      icon:"disparadores",    soon:true },
  { sec:"Catálogo & datos" },
  ...
  { id:"campos",      label:"Campos personalizados",icon:"campos",          soon:true },
  { id:"etiquetas",   label:"Etiquetas",            icon:"etiquetas",       soon:true },
