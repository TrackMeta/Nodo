...
const SYSTEM_EXTRACT = [
  ...
  '  "quien_es": hechos humanos útiles para tratarlo mejor la próxima vez (ej: "Compra para su mamá", "Es enfermera", "Prefiere que le escriban en la tarde") Y el OBJETIVO que él mismo declara al comprar (ej: "Quiere bajar barriga", "Busca ganar masa", "Nunca ha entrenado", "Lo quiere para su rutina de la mañana"): eso es lo que te dijo PARA que le vendas bien, y es lo que hace que la próxima conversación no empiece de cero.',
  ...
  "· El OBJETIVO que el cliente declara SÍ va (es lo que quiere lograr y te lo contó para comprar). Lo que NUNCA va es un juicio o una condición sobre su cuerpo o su salud: guarda \"Quiere bajar barriga\" y NUNCA \"Tiene sobrepeso\"; guarda \"Busca algo suave para empezar\" y NUNCA \"Está lesionado\" ni \"Es diabético\". La diferencia: lo primero es su meta —le sirve al vendedor y al cliente no le molesta leerlo—, lo segundo es una etiqueta sobre él que queda escrita en su ficha y la ve cualquiera del equipo, hoy y dentro de un año.",
