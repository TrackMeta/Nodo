...
const SYSTEM_EXTRACT = [
  ...
  "REGLAS ESTRICTAS:",
  "· PROHIBIDO incluir datos operativos de la venta: nombre del cliente, dónde vive (ciudad/distrito/dirección — tampoco \"es de provincia\" ni \"vive en el interior\"), DNI, teléfono, método de pago, producto, talla, color, cantidad, precio, sede/agencia. TODO eso ya se guarda aparte — si lo pones acá, es un ERROR. Ej. de lo que NUNCA debes devolver: \"Se llama Ana\", \"Vive en Trujillo\", \"Nombre real es...\", \"Talla 38\", \"Paga con Yape\".",
  ...
  "· Guarda SOLO lo que dijo EL CLIENTE. Nunca copies frases tuyas ni del negocio: los títulos y ganchos de los mensajes de venta («Entrena en casa sin llenarte de máquinas») son publicidad, no datos de esta persona, y meterlos en su ficha la ensucia y desplaza lo que sí sirve.",
